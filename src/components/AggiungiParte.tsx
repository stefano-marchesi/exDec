...
<Greet name="Stefano" />
      ...
      {aperto &&
        <div className=" bg-zinc-900/90 m-3 p-3">
          <div className=" text-orange-400 font-semibold text-center text-lg flex justify-center">Quale parte del corpo vuoi allenare? </div>
          <div className="mb-3 p-3 flex flex-col align-middle justify-center items-center">
            <input className="border-2 w-2/3 border-black bg-slate-600 text-gray-300 rounded" value={parte.nome} onChange={handleNameChange} />
            ...
            <div className="flex justify-center">
              <button className=" mt-5 w-20 pl-1 pr-1 text-center inline-block align-text-top border-2 border-black bg-orange-500 text-gray-900 font-semibold rounded-full " onClick={handleClick}>INVIA</button>
            </div>
          </div>
        </div>
